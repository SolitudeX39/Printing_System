...
function Printers() {
    ...
    const handleSettingsClick = (printerId) => {
        setActivePrinter(printerId);
        showSettingsAlert(printerId);
    };
    ...
    const showSettingsAlert = (printerId) => {
        const printer = printers.find(p => p.id === printerId);

        Swal.fire({
            title: `Printer ${printerId} Settings`,
            html: `
                <div style="display: flex; flex-direction: column; align-items: center;">
                    <input id="name-input" class="swal2-input" placeholder="Name" value="${printer.name}" style="width: 100%; margin-bottom: 10px;">
                    <input id="location-input" class="swal2-input" placeholder="Location" style="width: 100%; margin-bottom: 10px;">
                    <input id="critical-ink-input" class="swal2-input" placeholder="Critical Ink Level" style="width: 100%; margin-bottom: 10px;">
                </div>
            `,
            showCancelButton: true,
            ...
            preConfirm: () => {
                ...
                const location = document
                    ...
                    .value;
                const criticalInkLevel = document
    ...
    return (
        <div className="min-h-screen flex flex-col bg-white">
            ...
            <div
                ...
                <div
                    className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 w-full max-w-7xl">
