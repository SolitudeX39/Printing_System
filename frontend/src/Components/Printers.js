...
function Printers() {
return (
  <div className="flex flex-col mx-auto w-full shadow-sm bg-[color:var(--sds-color-background-default-default)] max-w-[480px]">
    <div className="flex gap-5 justify-between px-4 py-4 mr-52 w-full shadow-sm bg-neutral-100 text-zinc-900">
      ...
      <div className="justify-center px-4 py-3.5 text-sm leading-6 whitespace-nowrap rounded-2xl bg-[color:var(--sds-color-background-disabled-default)]">
        Filter
      </div>
    </div>
    <div className="flex gap-3 self-start ml-3.5">
      <div className="flex flex-col grow shrink-0 self-start mt-7 basis-0 w-fit">
        ...
        <div className="flex flex-col px-5 pt-3 pb-8 mt-5 w-full bg-[color:var(--sds-color-background-disabled-default)] text-zinc-900">
        ...
        <div className="flex flex-col px-5 pt-3 pb-5 mt-3 w-full bg-[color:var(--sds-color-background-disabled-default)]">
          ...
          <div className="flex overflow-hidden relative flex-col justify-center items-start mt-2 border-solid aspect-[62.4] border-[5px] border-zinc-200 stroke-[5px] stroke-zinc-200">
            <img
              loading="lazy"
        ...
        <div className="flex flex-col px-5 pt-3 pb-5 mt-3 w-full bg-[color:var(--sds-color-background-disabled-default)]">
          <div className="flex gap-5 justify-between items-start leading-[160%] text-zinc-900">
            <div className="flex flex-col mt-4">
      ...
      <div className="flex flex-col justify-center px-1 py-20 border border-solid bg-[color:var(--sds-color-background-default-default)] border-zinc-200">
        <div className="shrink-0 mt-16 rounded-md bg-neutral-300 h-[398px]" />
      </div>
    </div>
    <div className="flex flex-col justify-center items-start px-4 py-4 w-full text-lg leading-7 whitespace-nowrap bg-gray-100 shadow text-zinc-900">
      <div className="justify-center px-6 py-4 rounded-3xl bg-[color:var(--sds-color-background-disabled-default)]">
        Settings
      </div>
    </div>
  </div>
